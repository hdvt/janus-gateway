            ...
            t.exports = function(e, t) {
                ...
                var f = function(r) {
                    ...
                    if (r.iceServers = o(r.iceServers || [], t), this._iceGatherers = [], r.iceCandidatePoolSize)
                        for (var a = r.iceCandidatePoolSize; a > 0; a--) this._iceGatherers.push(new e.RTCIceGatherer({
                ...
                Object.defineProperty(f.prototype, "localDescription", {
                    ...
                    return i.canTrickleIceCandidates = !!g && g.substr(14).split(" ").indexOf("trickle") >= 0, f.forEach(function(s, d) {
                        ...
                        var R, _, E, P, b, k, w, I, O, D, M, L = p.parseRtpParameters(s);
                        g || (D = p.getIceParameters(s, v), M = p.getDtlsParameters(s, v), M.role = "client"), w = p.parseRtpEncodingParameters(s);
                        var x = p.parseRtcpParameters(s),
                            A = p.matchPrefix(s, "a=end-of-candidates", v).length > 0,
                            j = p.matchPrefix(s, "a=candidate:").map(function(e) {
                                return p.parseCandidate(e)
                            }).filter(function(e) {
                                return 1 === e.component
                            });
                        if (("offer" === n.type || "answer" === n.type) && !g && m && d > 0 && i.transceivers[d] && (i._disposeIceAndDtlsTransports(d), i.transceivers[d].iceGatherer = i.transceivers[0].iceGatherer, i.transceivers[d].iceTransport = i.transceivers[0].iceTransport, i.transceivers[d].dtlsTransport = i.transceivers[0].dtlsTransport, i.transceivers[d].rtpSender && i.transceivers[d].rtpSender.setTransport(i.transceivers[0].dtlsTransport), i.transceivers[d].rtpReceiver && i.transceivers[d].rtpReceiver.setTransport(i.transceivers[0].dtlsTransport)), "offer" !== n.type || g) "answer" !== n.type || g || (R = i.transceivers[d], _ = R.iceGatherer, E = R.iceTransport, P = R.dtlsTransport, b = R.rtpReceiver, k = R.sendEncodingParameters, I = R.localCapabilities, i.transceivers[d].recvEncodingParameters = w, i.transceivers[d].remoteCapabilities = L, i.transceivers[d].rtcpParameters = x, j.length && "new" === E.state && (!h && !A || m && 0 !== d ? j.forEach(function(e) {
                            c(R.iceTransport, e)
                        }) : E.setRemoteCandidates(j)), m && 0 !== d || ("new" === E.state && E.start(_, D, "controlling"), "new" === P.state && P.start(M)), i._transceive(R, "sendrecv" === C || "recvonly" === C, "sendrecv" === C || "sendonly" === C), !b || "sendrecv" !== C && "sendonly" !== C ? delete R.rtpReceiver : (O = b.track, y ? (o[y.stream] || (o[y.stream] = new e.MediaStream), r(O, o[y.stream]), a.push([O, b, o[y.stream]])) : (o.default || (o.default = new e.MediaStream), r(O, o.default), a.push([O, b, o.default]))));
                        else {
                            R = i.transceivers[d] || i._createTransceiver(f), R.mid = T, R.iceGatherer || (R.iceGatherer = i._createIceGatherer(d, m)), j.length && "new" === R.iceTransport.state && (!A || m && 0 !== d ? j.forEach(function(e) {
                                c(R.iceTransport, e)
                            }) : R.iceTransport.setRemoteCandidates(j)), I = e.RTCRtpReceiver.getCapabilities(f), t < 15019 && (I.codecs = I.codecs.filter(function(e) {
                                return "rtx" !== e.name
                            })), k = R.sendEncodingParameters || [{
                                ssrc: 1001 * (2 * d + 2)
                            }];
                            var N = !1;
                            if ("sendrecv" === C || "sendonly" === C) {
                                if (N = !R.rtpReceiver, b = R.rtpReceiver || new e.RTCRtpReceiver(R.dtlsTransport, f), N) {
                                    var U;
                                    O = b.track, y && "-" === y.stream || (y ? (o[y.stream] || (o[y.stream] = new e.MediaStream, Object.defineProperty(o[y.stream], "id", {
                                        get: function() {
                                            return y.stream
                                        }
                                    ...
                                    }), U = o[y.stream]) : (o.default || (o.default = new e.MediaStream), U = o.default)), U && (r(O, U), R.associatedRemoteMediaStreams.push(U)), a.push([O, b, U])
                                }
                            ...
                            R.localCapabilities = I, R.remoteCapabilities = L, R.rtpReceiver = b, R.rtcpParameters = x, R.sendEncodingParameters = k, R.recvEncodingParameters = w, i._transceive(i.transceivers[d], !1, N)
                        }
                    ...
                    r.transceivers.forEach(function(n, i) {
                        ...
                        o && t >= 15019 && "video" === a && !d[0].rtx && (d[0].rtx = {
                            ssrc: d[0].ssrc + 1
                        }), n.wantReceive && (n.rtpReceiver = new e.RTCRtpReceiver(n.dtlsTransport, a)), n.localCapabilities = c, n.sendEncodingParameters = d
                    ...
                    return e && void 0 === e.sdpMLineIndex && !e.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise(function(n, i) {
                        ...
                        if (e && "" !== e.candidate) {
                            ...
                            for (var f = 0; f < r.transceivers.length && (r.transceivers[f].rejected || (r.transceivers[f].iceTransport.addRemoteCandidate({}), t = p.getMediaSections(r._remoteDescription.sdp), t[f] += "a=end-of-candidates\r\n", r._remoteDescription.sdp = p.getDescription(r._remoteDescription.sdp) + t.join(""), !r.usingBundle)); f++);
                        n()
                    })
            ...
            n.generateIdentifier = function() {
                ...
                d.length > 0 && d[0].length > 1 && d[0][0] === c && (t = d[0][1]), i.codecs.forEach(function(e) {
                    if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                        ...
                        c && t && (n.rtx = {
                            ssrc: t
                        }), r.push(n), o && (n = JSON.parse(JSON.stringify(n)), n.fec = {
                            ssrc: t,
                        ...
                        if (e && "object" == typeof e.video) {
                            ...
                            if (s && ("user" === s.exact || "environment" === s.exact || "user" === s.ideal || "environment" === s.ideal) && (!r.mediaDevices.getSupportedConstraints || !r.mediaDevices.getSupportedConstraints().facingMode || c)) {
                                ...
                                if ("environment" === s.exact || "environment" === s.ideal ? d = ["back", "rear"] : "user" !== s.exact && "user" !== s.ideal || (d = ["front"]), d) return r.mediaDevices.enumerateDevices().then(function(t) {
                                    ...
                                    return !r && t.length && -1 !== d.indexOf("back") && (r = t[t.length - 1]), r && (e.video.deviceId = s.exact ? {
                                        exact: r.deviceId
                                    } : {
                                        ideal: r.deviceId
                                    }), e.video = o(e.video), i("chrome: " + JSON.stringify(e)), n(e)
                                })
                            }
                            e.video = o(e.video)
                        }
                ...
                shimGetDisplayMedia: function(e, t) {
                    "getDisplayMedia" in e.navigator || (navigator.getDisplayMedia = function(e) {
                        ...
                        return !0 === e.video ? e.video = {
                            mediaSource: t
                        } : e.video.mediaSource = t, navigator.mediaDevices.getUserMedia(e)
                    })
                }
            }
        }, {
        ...
        14: [function(e, t, r) {
            ...
            t.exports = {
                ...
                detectBrowser: function(e) {
                    ...
                    else if (t.webkitGetUserMedia) r.browser = "chrome", r.version = n(t.userAgent, /Chrom(e|ium)\/(\d+)\./, 2);
                    else if (t.mediaDevices && t.userAgent.match(/Edge\/(\d+).(\d+)$/)) r.browser = "edge", r.version = n(t.userAgent, /Edge\/(\d+).(\d+)$/, 2);
                    else {
...
StringeeUtil.allClientsOfThisBrowser = [], StringeeUtil.allClients = [], StringeeUtil.getActiveClientId = function() {
    ...
    var t = this;
    this.socket && (this.socket.disconnect(), this.socket = null), this.socket = io(t._stringeeServerAddr, {
        autoConnect: !1
    ...
    if ("CALL_STATE" === e.type) {
        ...
        r && (r._callOnEvent("otherdevice", {
            type: "CALL_STATE",
            code: t.code
        }), 200 !== t.code && 486 !== t.code && 603 !== t.code || (console.log("===xem vao day ko: _freeResource"), r.ended = !0, r._freeResource(), r.onRemove()))
    } else if ("CALL_END" === e.type) {
        var r = this.findCallByCallId(t.callId);
        r && (r.ended = !0, r._callOnEvent("otherdevice", {
            type: "CALL_END"
        }))
...
StringeeCall.prototype.makeCall = function(e) {
    ...
    var t = this;
    if (t.ended = !0, !t._pc && e) return void e.call(t, {
        r: -1
    });
    var r = {
        callId: this.callId
    ...
    this.client._sendMessage(StringeeServiceType.CALL_STOP, r, function(r) {
        0 === r.r && (t._freeResource(), t.onRemove()), e && e.call(t, {
            r: r.r
        })
    })
...
StringeeClient.prototype.on = function(e, t) {
    ...
    return navigator && navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia
};
...
StringeeCall.prototype._initPeerConnection = function(e, t, r) {
    function n(n) {
        ...
        try {
            ...
            o.client._sendMessage(StringeeServiceType.CALL_STOP, s, function(e) {}), o._callOnEvent("error", {
    ...
    var o = this,
        a = {
            audio: !0,
            video: o._buildVideoConstraints(!1)
        };
    ...
    this.isIncomingCall ? this._callOnEvent("error", {
        ...
        code: 1e3,
        moreInfo: e
    }) : this.client._sendMessage(StringeeServiceType.CALL_STOP, {
        callId: this.callId
    }, function(e) {})
